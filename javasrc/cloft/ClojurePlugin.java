...
public class ClojurePlugin extends JavaPlugin implements Listener {
    ...
    public void onPlayerRespawn(PlayerRespawnEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "player-respawn-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    ...
    public void onProjectileLaunchEvent(ProjectileLaunchEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "projectile-launch-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onCreatureSpawnEvent(CreatureSpawnEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "creature-spawn-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onFoodLevelChange(FoodLevelChangeEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "food-level-change-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onEntityCombust(EntityCombustEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "entity-combust-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    ...
    */
    ...
    public void onVehicleBlockCollision(VehicleBlockCollisionEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "vehicle-block-collision-event");
        if (f.isBound()) f.invoke(event);
    }
    /*
    @EventHandler
    public void onVehicleCreate(VehicleCreateEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "vehicle-create-event");
        if (f.isBound()) f.invoke(event);
    }
    */
    @EventHandler
    public void onVehicleDamage(VehicleDamageEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "vehicle-damage-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleDestroy(VehicleDestroyEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "vehicle-destroy-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleEnter(VehicleEnterEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "vehicle-enter-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleEntityCollision(VehicleEntityCollisionEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "vehicle-entity-collision-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleExit(VehicleExitEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "vehicle-exit-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleMove(VehicleMoveEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "vehicle-move-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleUpdate(VehicleUpdateEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "vehicle-update-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onChunkPopulate(ChunkPopulateEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "chunk-populate-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onPaintingBreakByEntity(PaintingBreakByEntityEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("mc68.core", "painting-break-by-entity-event");
        if (f.isBound()) f.invoke(event);
    }
